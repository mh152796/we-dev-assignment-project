...
class HomePage extends StatelessWidget {
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "Filter",
                                  style: AppTextStyles.textStyleRoboto700.setColor(AppColor.blackColor).fontWeightBold.setFontSize(18),
                                ),
                              ),
                              buildCheckBoxRow(label: filterItems[index],
                                  value: false,
  ...
  Widget buildCheckBoxRow({required String label, required ValueChanged<bool?> onPressed, bool? value}) {
    return Row(
                              children: [
                                Checkbox(
                                  value: value,
                                  ...
                                  side: MaterialStateBorderSide.resolveWith(
                                        (states) => BorderSide(width: 2.0, color: AppColor.checkBoxColor,
                                        ),
                                  ),
                                  onChanged: onPressed,
                                ),
                                Expanded(
                                  child: Text(label, style: AppTextStyles.textStyleRoboto400.setFontSize(15),),
                                ),
                              ],
                            );
  }
